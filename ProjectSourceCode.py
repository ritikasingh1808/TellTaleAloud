...
# This project is done by: Ritika
...
Label(root, text='TELL TALE ALOUD', font=('Comic Sans MS', 25)).pack(side=TOP, pady=10)
# other stylish fonts can be used here too

photo = PhotoImage(file=r"D:\python projects\audiobook\Audiobook-Project\telltalealoud.gif")  # Creating a photoimage object to use image . JPEG wouldn't work here
...
for num in range(0,pages):
    ...
    player.say(text)
    player.runAndWait()
engine.save_to_file(text, 'Audiobook created by Ritika.mp3')   # Saving the voice to a file 
engine.runAndWait()
